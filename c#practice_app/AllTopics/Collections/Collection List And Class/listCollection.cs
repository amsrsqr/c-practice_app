...
namespace c_practice_app.AllTopics.Collections.Dictionary
{
    public class listCollection
    {
        ...
        public static void RunListCollection()
        {
            // Create Customer Objects
            updatedCustomer customer1 = new updatedCustomer()
            {
                ID = 101,
                Name = "Mark",
                Salary = 5000
            ...
            updatedCustomer customer2 = new updatedCustomer()
            {
                ID = 102,
                Name = "Pam",
                Salary = 7000
            ...
            updatedCustomer customer3 = new updatedCustomer()
            {
                ID = 104,
                Name = "Rob",
                Salary = 5500
            ...
            updatedCustomer[] arrayCustomers = new updatedCustomer[2];
            ...
            // This is because, arrays does not grow in size automatically. due to length is 2
            ...
            List<updatedCustomer> listCustomers = new List<updatedCustomer>(2);
            ...
            updatedCustomer cust = listCustomers[0];
            ...
            {
                updatedCustomer customer = listCustomers[i];
                Console.WriteLine("ID = {0}, Name = {1}, Salary = {2}",
            ...
            // Using foreach loop
            foreach (updatedCustomer c in listCustomers)
            {
