...
namespace Amol
{
    ...
    class Program
    {
        ...
        public static void RunProgram()  // This should be main method to run this program  public static void Main()
        {
            ...
            ThreadFunctionUsingCallback number = new ThreadFunctionUsingCallback(target, callbackMethod);
    ...
    // Step 2: Create ThreadFunctionUsingCallback class to compute the sum of numbers and
    // to call the callback method
    public class ThreadFunctionUsingCallback
    {
        ...
        public ThreadFunctionUsingCallback(int target, SumOfNumbersCallback callbackMethod)
        {
            this._target = target;
